...
const MESSAGES: Record<Mood, Line[]> = {
  drinking: [
    ...
    '这水比我想象中还顺滑', '看你喝水比看剧还开心',
    '你喝水我开心，多简单的快乐', '这一口下肚，宇宙都和谐了',
    '我刚才差点哭出来你信吗', '这水……有股温柔的味道（？）',
    '行，这才是人该做的事', '咕咚一声，世界都安静了',
    '宝贝你今天喝水的样子真的有点迷人',
  ...
  thirsty: [
    ...
    '不喝水的人类我见过，但没见过这么不喝的',
    '喂喂喂！我快不行了喂', '我嘴唇都干裂了你看不见？',
    '行了别装看不见我的眼神', '我都明示成这样了你还不喝？',
    '不喝水的我，已经准备好骂你了', '我都开始想象水的味道了',
    '别让我下跪，杯子拿起来就完事了',
    '你这样以后皮肤干得能磨砂',
    '我看你是要把杯子供起来吃灰是吧',
    '渴 / 真渴 / 真的真的渴', '不喝水你良心呢',
  ...
  encouraging: [
    ...
    '差一点就追上了，别又躺平啊', '这点距离都跑不动？我替你尴尬',
    '加把劲！至少别让别人看出来你没喝', '我现在比你还紧张',
    '不喝就别怪我晚上吓你', '别想了，杯子已经在那里盯着你了',
    '一杯而已，你又不是没钱', '别人都达标了你还在玩手机？',
    '加油 加油 加油（喊累了）', '你不喝我替你喝啊！（其实不能）',
    '这进度，路过的鱼都笑我了',
  ...
  happy: [
    ...
    '继续这样，别让我惊艳错了人', '你今天像换了个人，我喜欢',
    '行，是个能交付的合作伙伴', '我打心眼里替你舒坦',
    '保持住，别一会儿就翻车了', '这状态稳定输出我能看一年',
    '看着你喝水，我都想给你颁奖',
    '我决定原谅你上次那杯没喝的水',
    '今天的你，连风都觉得清爽',
