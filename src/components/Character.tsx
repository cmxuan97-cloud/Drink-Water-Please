...
type Spec = {
  viewBox: string;
  render: (mood: Mood) => JSX.Element;
};

// helper: mood-expressive eyes
const Eye = ({ x, y, r = 4, mood = 'idle' as Mood, withHighlight = false, closed = false }: { x: number; y: number; r?: number; mood?: Mood; withHighlight?: boolean; closed?: boolean }) => {
  if (mood === 'dying') {
    return (
      <g stroke="#1a1408" strokeWidth={2.2} strokeLinecap="round">
        <line x1={x - r} y1={y - r} x2={x + r} y2={y + r} />
        <line x1={x + r} y1={y - r} x2={x - r} y2={y + r} />
      </g>
    );
  }
  const happy = mood === 'drinking' || mood === 'celebrating' || mood === 'happy';
  if (happy || closed) {
    return <path d={`M ${x - r} ${y} Q ${x} ${y - r * 1.2} ${x + r} ${y}`} stroke="#1a1408" strokeWidth={2.2} fill="none" strokeLinecap="round" />;
  }
  return (
    <>
...
const Mouth = ({ x, y, w = 10, mood = 'idle' as Mood, color = '#1a1408' }: { x: number; y: number; w?: number; mood?: Mood; color?: string }) => {
  if (mood === 'dying') return <ellipse cx={x} cy={y} rx={w * 0.5} ry={w * 0.55} fill={color} />;
  if (mood === 'thirsty') return <path d={`M ${x - w * 0.7} ${y + 3} Q ${x} ${y - w * 0.35} ${x + w * 0.7} ${y + 3}`} stroke={color} strokeWidth={1.8} fill="none" strokeLinecap="round" />;
  if (mood === 'drinking' || mood === 'celebrating' || mood === 'happy') return <path d={`M ${x - w} ${y} Q ${x} ${y + w * 0.8} ${x + w} ${y}`} stroke={color} strokeWidth={2} fill="none" strokeLinecap="round" />;
  return <path d={`M ${x - w * 0.7} ${y} Q ${x} ${y + w * 0.4} ${x + w * 0.7} ${y}`} stroke={color} strokeWidth={1.8} fill="none" strokeLinecap="round" />;
};
...
const CHARACTERS: Record<CharacterId, Spec> = {
  ...
  mola: {
    ...
    render: (m) => (
      <>
        ...
        {Eye({ x: 84, y: 115, r: 5.5, mood: m, withHighlight: true })}
      </>
    ),
  },
  ...
  dino: {
    ...
    render: (m) => (
      <>
        ...
        {Eye({ x: 205, y: 82, r: 4.5, mood: m })}
        {Mouth({ x: 195, y: 120, w: 8, mood: m })}
  ...
  kong: {
    ...
    render: (m) => {
      const e = m === 'drinking' || m === 'celebrating' || m === 'happy';
      return (
        <>
          <defs>
          ...
          {m === 'dying' ? (
            <g stroke="#1a1408" strokeWidth={2.2} strokeLinecap="round">
              <path d="M 98 72 L 112 82" /><path d="M 112 72 L 98 82" />
              <path d="M 128 72 L 142 82" /><path d="M 142 72 L 128 82" />
            </g>
          ) : e ? (
    ...
    render: (m) => {
      ...
      return (
        <>
          ...
          {m === 'dying' ? (
            <g stroke="#cc3030" strokeWidth={2.2} strokeLinecap="round">
              <line x1={202} y1={77} x2={212} y2={87}/><line x1={212} y1={77} x2={202} y2={87}/>
            </g>
          ) : e ? (
    ...
    render: (m) => {
      ...
      return (
        <>
          ...
          {m === 'dying' ? (
            <g stroke="#88e0ff" strokeWidth={2.2} strokeLinecap="round">
              <line x1={96} y1={75} x2={110} y2={89}/><line x1={110} y1={75} x2={96} y2={89}/>
              <line x1={130} y1={75} x2={144} y2={89}/><line x1={144} y1={75} x2={130} y2={89}/>
            </g>
          ) : e ? (
          ...
          {m === 'dying' ? (
            <g stroke="#88e0ff" strokeWidth={2} fill="none" strokeLinecap="round">
              <path d="M 96 96 Q 103 102 110 96" /><path d="M 110 96 Q 117 102 124 96" /><path d="M 124 96 Q 131 102 138 96" />
            </g>
          ) : e ? (
            <path d="M 96 98 Q 120 108 144 98" stroke="#88e0ff" strokeWidth={2} fill="none" strokeLinecap="round" />
          ) : m === 'thirsty' ? (
            <path d="M 96 104 Q 120 96 144 104" stroke="#88e0ff" strokeWidth={2} fill="none" strokeLinecap="round" />
          ) : (
    ...
    render: (m) => {
      ...
      return (
        <>
          ...
          {m === 'dying' ? (
            <g stroke="#1a2638" strokeWidth={2.5} strokeLinecap="round">
              <line x1={93} y1={83} x2={111} y2={101}/><line x1={111} y1={83} x2={93} y2={101}/>
              <line x1={129} y1={83} x2={147} y2={101}/><line x1={147} y1={83} x2={129} y2={101}/>
            </g>
          ) : e ? (
          ...
          {m === 'dying' ? <ellipse cx={120} cy={125} rx={12} ry={14} fill="#1a2638" /> :
           e ? <path d="M 105 118 Q 120 128 135 118" stroke="#1a2638" strokeWidth={2.5} fill="none" strokeLinecap="round" /> :
           m === 'thirsty' ? <path d="M 107 124 Q 120 116 133 124" stroke="#1a2638" strokeWidth={2} fill="none" strokeLinecap="round" /> :
           <ellipse cx={120} cy={120} rx={8} ry={9} fill="#1a2638" />}
          {Blush({ x: 80, y: 115 })}
          {Blush({ x: 160, y: 115 })}
        </>
      );
    ...
    render: (m) => {
      ...
      return (
        <>
          ...
          {m === 'dying' ? (
            <g stroke="#1a2638" strokeWidth={2.5} strokeLinecap="round">
              <line x1={91} y1={61} x2={109} y2={79}/><line x1={109} y1={61} x2={91} y2={79}/>
              <line x1={131} y1={61} x2={149} y2={79}/><line x1={149} y1={61} x2={131} y2={79}/>
            </g>
          ) : e ? (
            <g stroke="#1a2638" strokeWidth={2.5} fill="none" strokeLinecap="round">
          ...
          {Mouth({ x: 120, y: 112, w: 5, mood: m, color: '#3a8a5a' })}
    ...
    render: (m) => {
      ...
      return (
        <>
          ...
          {m === 'dying' ? (
            <g stroke="#1a2638" strokeWidth={2.4} strokeLinecap="round">
              <line x1={92} y1={58} x2={108} y2={74}/><line x1={108} y1={58} x2={92} y2={74}/>
              <line x1={132} y1={58} x2={148} y2={74}/><line x1={148} y1={58} x2={132} y2={74}/>
            </g>
          ) : e ? (
          ...
          {Mouth({ x: 120, y: 90, w: 10, mood: m, color: '#5a3a78' })}
          {Blush({ x: 80, y: 86 })}
          {Blush({ x: 160, y: 86 })}
        </>
      );
        ...
        <>
          ...
          {m === 'dying' ? (
            <g stroke="white" strokeWidth={2.2} strokeLinecap="round">
              <line x1={87} y1={83} x2={101} y2={97}/><line x1={101} y1={83} x2={87} y2={97}/>
              <line x1={139} y1={83} x2={153} y2={97}/><line x1={153} y1={83} x2={139} y2={97}/>
            </g>
          ) : e ? (
    ...
    render: (m) => {
      ...
      return (
        <>
          ...
          {m === 'dying' ? (
            <g stroke="#1a1408" strokeWidth={2.2} strokeLinecap="round">
              <line x1={100} y1={75} x2={110} y2={85}/><line x1={110} y1={75} x2={100} y2={85}/>
              <line x1={130} y1={75} x2={140} y2={85}/><line x1={140} y1={75} x2={130} y2={85}/>
            </g>
          ) : e ? (
            <g stroke="#1a1408" strokeWidth={2.2} fill="none" strokeLinecap="round">
        ...
        <>
          ...
          {m === 'dying' ? (
            <g stroke="#1a1408" strokeWidth={2.5} strokeLinecap="round">
              <line x1={88} y1={86} x2={108} y2={104}/><line x1={108} y1={86} x2={88} y2={104}/>
              <line x1={132} y1={86} x2={152} y2={104}/><line x1={152} y1={86} x2={132} y2={104}/>
            </g>
          ) : e ? (
  ...
  unicorn: {
    ...
    render: (m) => (
      <>
        ...
        {m === 'dying' ? (
          <g stroke="#1a1408" strokeWidth={2.4} strokeLinecap="round">
            <line x1={65} y1={118} x2={75} y2={128}/><line x1={75} y1={118} x2={65} y2={128}/>
          </g>
        ) : (m === 'drinking' || m === 'celebrating' || m === 'happy') ? (
    ...
    render: (m) => {
      ...
      return (
        <>
          ...
          {m === 'dying' ? (
            <g stroke="#1a1408" strokeWidth={2.4} strokeLinecap="round">
              <line x1={175} y1={62} x2={185} y2={72}/><line x1={185} y1={62} x2={175} y2={72}/>
            </g>
          ) : e ? (
          ...
          {Mouth({ x: 185, y: 105, w: 15, mood: m, color: '#5a1010' })}
          <g fill="#fcd34d">
    ...
    render: (m) => {
      ...
      return (
        <>
          ...
          {m === 'dying' ? (
            <g stroke="#1a1408" strokeWidth={2.2} strokeLinecap="round">
              <line x1={95} y1={91} x2={105} y2={101}/><line x1={105} y1={91} x2={95} y2={101}/>
              <line x1={135} y1={91} x2={145} y2={101}/><line x1={145} y1={91} x2={135} y2={101}/>
            </g>
          ) : e ? (
            <g stroke="#1a1408" strokeWidth={2.2} fill="none" strokeLinecap="round">
    ...
    render: (m) => {
      ...
      return (
        <>
          ...
          {m === 'dying' ? (
            <g stroke="#1a1408" strokeWidth={2.2} strokeLinecap="round">
              <line x1={95} y1={86} x2={105} y2={96}/><line x1={105} y1={86} x2={95} y2={96}/>
              <line x1={135} y1={86} x2={145} y2={96}/><line x1={145} y1={86} x2={135} y2={96}/>
            </g>
          ) : e ? (
            <g stroke="#1a1408" strokeWidth={2.2} fill="none" strokeLinecap="round">
  ...
  bat: {
    ...
    render: (m) => {
      ...
      return (
        ...
        {m === 'dying' ? (
          <g stroke="#fcd34d" strokeWidth={2.4} strokeLinecap="round">
            <line x1={100} y1={105} x2={110} y2={115}/><line x1={110} y1={105} x2={100} y2={115}/>
            <line x1={130} y1={105} x2={140} y2={115}/><line x1={140} y1={105} x2={130} y2={115}/>
          </g>
        ) : e ? (
        ...
        {Mouth({ x: 120, y: 140, w: 8, mood: m, color: '#5a3870' })}
    ...
    render: (m) => {
      ...
      return (
        <>
          ...
          {m === 'dying' ? (
            <g stroke="#1a1408" strokeWidth={2.2} strokeLinecap="round">
              <line x1={100} y1={95} x2={110} y2={105}/><line x1={110} y1={95} x2={100} y2={105}/>
              <line x1={130} y1={95} x2={140} y2={105}/><line x1={140} y1={95} x2={130} y2={105}/>
            </g>
          ) : e ? (
            <g stroke="#1a1408" strokeWidth={2.2} fill="none" strokeLinecap="round">
  ...
  shark: {
    ...
    render: (m) => (
      <>
        ...
        {m === 'dying' ? (
          <g stroke="#1a1408" strokeWidth={2.2} strokeLinecap="round">
            <line x1={130} y1={92} x2={140} y2={102}/><line x1={140} y1={92} x2={130} y2={102}/>
          </g>
        ) : (m === 'drinking' || m === 'celebrating' || m === 'happy') ? (
  ...
  dolphin: {
    ...
    render: (m) => (
      <>
        ...
        {Eye({ x: 90, y: 115, r: 4, mood: m, withHighlight: true })}
        {Mouth({ x: 55, y: 140, w: 8, mood: m, color: '#3a6890' })}
      </>
    ),
  },
  ...
  seahorse: {
    ...
    render: (m) => (
      <>
        ...
        {Eye({ x: 142, y: 52, r: 3, mood: m })}
        {Mouth({ x: 135, y: 68, w: 5, mood: m })}
    ...
    render: (m) => {
      ...
      return (
        <>
          ...
          {m === 'dying' ? (
            <g stroke="#5a2870" strokeWidth={2.4} strokeLinecap="round">
              <line x1={100} y1={88} x2={116} y2={104}/><line x1={116} y1={88} x2={100} y2={104}/>
              <line x1={134} y1={88} x2={150} y2={104}/><line x1={150} y1={88} x2={134} y2={104}/>
            </g>
          ) : e ? (
          ...
          {Mouth({ x: 125, y: 113, w: 10, mood: m, color: '#5a2870' })}
  ...
  rabbit: {
    ...
    render: (m) => (
      <>
        ...
        {Eye({ x: 100, y: 105, r: 4, mood: m, withHighlight: true })}
        {Eye({ x: 140, y: 105, r: 4, mood: m, withHighlight: true })}
        <path d="M 115 122 L 120 128 L 125 122 Q 125 130 120 132 Q 115 130 115 122 Z" fill="#ffa0c0" />
        {Mouth({ x: 120, y: 130, w: 12, mood: m })}
  ...
  squirrel: {
    ...
    render: (m) => (
      <>
        ...
        {Eye({ x: 105, y: 110, r: 5, mood: m, withHighlight: true })}
        {Eye({ x: 135, y: 110, r: 5, mood: m, withHighlight: true })}
        <ellipse cx={120} cy={130} rx={4} ry={3} fill="#1a1408" />
        {Mouth({ x: 120, y: 134, w: 10, mood: m })}
        <g fill="#1a1408">
        ...
        <>
          ...
          {m === 'dying' ? (
            <g stroke="white" strokeWidth={2} strokeLinecap="round">
              <line x1={95} y1={99} x2={105} y2={109}/><line x1={105} y1={99} x2={95} y2={109}/>
              <line x1={135} y1={99} x2={145} y2={109}/><line x1={145} y1={99} x2={135} y2={109}/>
            </g>
          ) : e ? (
  ...
  flamingo: {
    ...
    render: (m) => (
      <>
        ...
        {Eye({ x: 145, y: 38, r: 3, mood: m, withHighlight: true })}
        {Mouth({ x: 140, y: 52, w: 5, mood: m, color: '#e870a8' })}
  ...
  parrot: {
    ...
    render: (m) => (
      <>
        ...
        {Eye({ x: 110, y: 80, r: 4.5, mood: m, withHighlight: true })}
        {Mouth({ x: 115, y: 100, w: 10, mood: m, color: '#7a1010' })}
        <g fill="#ffd040">
  ...
  chick: {
    ...
    render: (m) => (
      <>
        ...
        {Eye({ x: 100, y: 115, r: 5, mood: m, withHighlight: true })}
        {Eye({ x: 140, y: 115, r: 5, mood: m, withHighlight: true })}
        <path d="M 110 130 L 130 130 L 122 142 L 118 142 Z" fill="#ff9050" />
        {Mouth({ x: 120, y: 146, w: 8, mood: m })}
  ...
  peacock: {
    ...
    render: (m) => (
      <>
        ...
        {Eye({ x: 115, y: 138, r: 4, mood: m, withHighlight: true })}
        {Eye({ x: 135, y: 138, r: 4, mood: m, withHighlight: true })}
        <path d="M 118 148 L 132 148 L 125 158 Z" fill="#ffc040" />
        {Mouth({ x: 125, y: 162, w: 8, mood: m })}
      </>
    ),
  },
  ...
  turtle: {
    ...
    render: (m) => (
      <>
        ...
        {Eye({ x: 45, y: 128, r: 3.5, mood: m, withHighlight: true })}
        {Mouth({ x: 42, y: 142, w: 7, mood: m })}
  ...
  snake: {
    ...
    render: (m) => (
      <>
        ...
        {Eye({ x: 184, y: 45, r: 3.5, mood: m, withHighlight: true })}
  ...
  bee: {
    ...
    render: (m) => (
      <>
        ...
        {Eye({ x: 100, y: 80, r: 5, mood: m, withHighlight: true })}
        {Eye({ x: 140, y: 80, r: 5, mood: m, withHighlight: true })}
        {Mouth({ x: 120, y: 95, w: 10, mood: m })}
        <g stroke="#1a1408" strokeWidth={2.5} fill="none" strokeLinecap="round">
  ...
  ladybug: {
    ...
    render: (m) => (
      <>
        ...
        {Eye({ x: 100, y: 75, r: 5, mood: m, withHighlight: true })}
        {Eye({ x: 140, y: 75, r: 5, mood: m, withHighlight: true })}
        {Mouth({ x: 120, y: 90, w: 10, mood: m, color: '#fff' })}
        <g stroke="#1a1408" strokeWidth={2.5} fill="none" strokeLinecap="round">
  ...
  butterfly: {
    ...
    render: (m) => (
      <>
        ...
        {Eye({ x: 115, y: 95, r: 2.5, mood: m })}
        {Eye({ x: 125, y: 95, r: 2.5, mood: m })}
        {Mouth({ x: 120, y: 105, w: 5, mood: m })}
      </>
    ),
  },
  ...
  hamster: {
    ...
    render: (m) => (
      <>
        ...
        {Eye({ x: 100, y: 115, r: 4.5, mood: m, withHighlight: true })}
        {Eye({ x: 140, y: 115, r: 4.5, mood: m, withHighlight: true })}
        <path d="M 115 130 L 125 130 L 122 138 L 118 138 Z" fill="#ff8080" />
        <path d="M 120 138 L 120 145" stroke="#1a1408" strokeWidth={1.2} />
        {Mouth({ x: 120, y: 145, w: 12, mood: m })}
    ...
    render: (m) => {
      ...
      return (
        <>
          ...
          {m === 'dying' ? (
            <g stroke="#1a1408" strokeWidth={2.2} strokeLinecap="round">
              <line x1={92} y1={74} x2={108} y2={88}/><line x1={108} y1={74} x2={92} y2={88}/>
              <line x1={144} y1={74} x2={156} y2={88}/><line x1={156} y1={74} x2={144} y2={88}/>
            </g>
          ) : e ? (
            <g stroke="#1a1408" strokeWidth={2.2} fill="none" strokeLinecap="round">
          ...
          {m === 'dying' ? null : m === 'thirsty' ? (
            <path d="M 110 130 Q 125 123 140 130" stroke="#3a5828" strokeWidth={1.5} fill="none" strokeLinecap="round" />
          ) : e ? (
            <path d="M 108 122 Q 125 135 142 122" stroke="white" strokeWidth={1.5} fill="none" strokeLinecap="round" />
          ) : null}
        ...
        <>
          ...
          {m === 'dying' ? (
            <g stroke="#fff" strokeWidth={2.4} strokeLinecap="round">
              <line x1={95} y1={92} x2={111} y2={104}/><line x1={111} y1={92} x2={95} y2={104}/>
              <line x1={129} y1={92} x2={145} y2={104}/><line x1={145} y1={92} x2={129} y2={104}/>
            </g>
          ) : e ? (
          ...
          {Mouth({ x: 120, y: 130, w: 10, mood: m, color: '#a89868' })}
        </>
      );
    },
  },
  ...
  alpaca: {
    ...
    render: (m) => (
      <>
        ...
        {m === 'dying' ? (
          <g stroke="#1a1408" strokeWidth={2.2} strokeLinecap="round">
            <line x1={122} y1={62} x2={134} y2={70}/><line x1={134} y1={62} x2={122} y2={70}/>
            <line x1={146} y1={62} x2={158} y2={70}/><line x1={158} y1={62} x2={146} y2={70}/>
          </g>
        ) : (m === 'drinking' || m === 'celebrating' || m === 'happy') ? (
          <g stroke="#1a1408" strokeWidth={2.2} fill="none" strokeLinecap="round">
        ...
        {Mouth({ x: 140, y: 92, w: 5, mood: m, color: '#a07060' })}
    ...
    render: (m) => {
      ...
      return (
        <>
          ...
          {m === 'dying' ? (
            <g stroke="#1a1408" strokeWidth={2.4} strokeLinecap="round">
              <line x1={102} y1={115} x2={118} y2={127}/><line x1={118} y1={115} x2={102} y2={127}/>
              <line x1={132} y1={115} x2={148} y2={127}/><line x1={148} y1={115} x2={132} y2={127}/>
            </g>
          ) : e ? (
    ...
    render: (m) => {
      ...
      return (
        <>
          ...
          {m === 'dying' ? (
            <g stroke="#1a1408" strokeWidth={2.2} strokeLinecap="round">
              <line x1={102} y1={88} x2={114} y2={98}/><line x1={114} y1={88} x2={102} y2={98}/>
              <line x1={136} y1={88} x2={148} y2={98}/><line x1={148} y1={88} x2={136} y2={98}/>
            </g>
          ) : e ? (
            <g stroke="#1a1408" strokeWidth={2.2} fill="none" strokeLinecap="round">
